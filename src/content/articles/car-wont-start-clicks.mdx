...
<ToolsParts 
  mustHave={[
    { name: "Multimeter", description: "For testing battery voltage" },
    { name: "Wire brush or sandpaper", description: "Clean corroded terminals" },
    { name: "Adjustable wrench", description: "Tighten battery clamps" }
  ]}
  niceToHave={[
    { name: "Jumper cables or jump starter", description: "For testing and emergency starts" }
  ]}
/>
...
<AffiliateProduct 
  ...
  url="https://amazon.com/dp/B004LWLMHC"
  merchant="Amazon"
  price="$59.95"
...
<AffiliateProduct 
  ...
  url="https://amazon.com/dp/B000LRMM9S"
  merchant="Amazon"
  price="$199.99"
